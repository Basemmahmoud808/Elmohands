...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center py-16 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-15 select-none overflow-hidden font-math">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-right">
            ...
            <p className="text-base sm:text-lg text-chalk-muted font-medium max-w-2xl leading-relaxed">
              شرح مبسط، تطبيق عملي، بنك أسئلة وافي لكل فكرة، وااختبارات تفاعلية بعد كل درس لتضمن التفوق والدرجة النهائية بسهولة.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <Link
                href="#stages"
                className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-bold text-chalk bg-slate-900/80 hover:bg-slate-800 border border-slate-700/80 transition-all flex items-center justify-center gap-3"
              >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-cyan-electric/30 via-blue-ink/40 to-cyan-electric/20 blur-2xl animate-pulse"></div>

              {/* Main Card Container */}
              <div className="relative rounded-3xl bg-slate-950/80 backdrop-blur-2xl border-2 border-cyan-electric/40 p-6 shadow-cyan-glow-lg overflow-hidden text-center space-y-6">
                
                {/* Chalk Board Decorative Header */}
                <div className="flex items-center justify-between pb-4 border-b border-slate-800 text-xs font-semibold text-chalk-muted">
                ...
                <div className="relative w-44 h-44 mx-auto rounded-full bg-gradient-to-b from-blue-ink to-black border-4 border-cyan-electric flex items-center justify-center shadow-cyan-glow overflow-hidden">
                ...
                <div className="flex items-center justify-center gap-2 pt-2">
                  <span className="px-3 py-1 rounded-lg bg-slate-900/90 text-xs font-bold text-chalk border border-slate-700/80 flex items-center gap-1.5">
