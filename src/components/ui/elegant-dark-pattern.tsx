...
export function DarkGradientBg({ children, className }: DarkGradientBgProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none transition-opacity duration-300 dark:block hidden">
        <div
      ...
      {/* Light Mode Notebook & Grid Background */}
      <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-slate-100 via-white to-slate-100 dark:hidden block">
        <div
      ...
      <div
        className="absolute inset-0 pointer-events-none dark:opacity-20 opacity-10"
        style={{
