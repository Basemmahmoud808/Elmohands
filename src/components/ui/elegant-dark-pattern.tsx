...
export function DarkGradientBg({ children, className }: DarkGradientBgProps) {
  ...
  return (
    <div
      className={cn(
        'relative min-h-screen w-full transition-colors duration-300 overflow-hidden',
    ...
    >
      ...
      {!isDark && (
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-slate-100 via-white to-slate-100">
          <div
